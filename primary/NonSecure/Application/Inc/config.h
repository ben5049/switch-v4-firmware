...
#define ETH_INTERFACE_NUM                (0)     /* Primary NetXduo interface (0 = first normal interface, 1 = loopback) */
...
#define PHY_LINK_REQUIRED_FOR_NX_LINK    (false) /* Setting this to false means NetXduo will only require the switch to be initialed to count as having a link up. Default = true*/
