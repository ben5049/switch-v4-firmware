...
void MX_GPIO_Init(void)
{
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_12|GPIO_PIN_9|GPIO_PIN_13|GPIO_PIN_11
                          ...
                          |GPIO_PIN_6|GPIO_PIN_4|GPIO_PIN_2|GPIO_PIN_1
                          |GPIO_PIN_0;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_15|GPIO_PIN_14|GPIO_PIN_9|GPIO_PIN_12
                          ...
                          |GPIO_PIN_7|GPIO_PIN_11|GPIO_PIN_4|GPIO_PIN_2;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOH, &GPIO_InitStruct);

  /*Configure GPIO pins : PA12 PA10 PA8 PA4
                           PA3 PA0 PA6 PA5 */
  GPIO_InitStruct.Pin = GPIO_PIN_12|GPIO_PIN_10|GPIO_PIN_8|GPIO_PIN_4
                          |GPIO_PIN_3|GPIO_PIN_0|GPIO_PIN_6|GPIO_PIN_5;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*IO attributes management functions */
  HAL_GPIO_ConfigPinAttributes(GPIOF, PHY_WAKE_Pin|PHY3_INT_Pin|PHY_RST_Pin|VIN_VMON_Pin
                          |VIN_IMON_Pin, GPIO_PIN_NSEC);
