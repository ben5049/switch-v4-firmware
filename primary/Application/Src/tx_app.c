...
void tx_user_init(void *memory_ptr) {
    ...
    tx_thread_create(&switch_thread_handle,  "switch_thread",  switch_thread_entry,  0, switch_thread_stack,  SWITCH_THREAD_STACK_SIZE,  SWITCH_THREAD_PRIORIY,   SWITCH_THREAD_PREMPTION_PRIORIY, 1,                TX_AUTO_START);
    tx_thread_create(&stp_thread_handle,     "stp_thread",     stp_thread_entry,     0, stp_thread_stack,     STP_THREAD_STACK_SIZE,     STP_THREAD_PRIORIY,      STP_THREAD_PREMPTION_PRIORIY,    1,                TX_AUTO_START);
    tx_thread_create(&comms_thread_handle,   "comms_thread",   comms_thread_entry,   0, comms_thread_stack,   COMMS_THREAD_STACK_SIZE,   COMMS_THREAD_PRIORIY,    COMMS_THREAD_PREMPTION_PRIORIY,  1,                TX_DONT_START);
    tx_thread_create(&ptp_thread_handle,     "ptp_thread",     ptp_thread_entry,     0, ptp_thread_stack,     PTP_THREAD_STACK_SIZE,     PTP_THREAD_PRIORITY,     PTP_THREAD_PRIORITY,             TX_NO_TIME_SLICE, TX_DONT_START);
    // clang-format on
}
